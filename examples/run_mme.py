...
def run_experiment(variant):
    ...
    rqf1 = NNQFunction(env_spec=env.spec, hidden_layer_sizes=(M, M), name='rqf1')
    rqf2 = NNQFunction(env_spec=env.spec, hidden_layer_sizes=(M, M), name='rqf2')
    rvf = NNVFunction(env_spec=env.spec, hidden_layer_sizes=(M, M), name='rvf')
